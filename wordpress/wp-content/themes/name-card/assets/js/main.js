document.addEventListener('DOMContentLoaded', function() {
    console.log("Name Card Theme Loaded");
});
function cardPNG(){
...
// function downloadVCard(user_id) {
//     // Xây dựng URL để tải vCard
//     var url = "<?php echo esc_url(home_url()); ?>/index.php?download_vcard=true&user_id=" + user_id;
    
//     // Điều hướng đến URL để tải vCard
//     window.location.href = url;
// }

cardPNG();
// tạo url và hiện tên lên url